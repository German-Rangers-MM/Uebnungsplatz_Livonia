...
_targets = nearestObjects [position _center, ["TargetBase", "TargetP_Inf_F", "TargetP_Inf4_F", "TargetP_Inf2_F", "TargetP_Inf4_Acc2_F"], _dist];	//take all nearby practice targets
