...
{
	case "All": {(VVS_pre_Car + VVS_pre_Air + VVS_pre_Ship + VVS_pre_Armored + VVS_pre_Support + VVS_pre_Autonomous + VVS_Car + VVS_Air + VVS_Ship + VVS_Armored + VVS_Support + VVS_Autonomous)};
